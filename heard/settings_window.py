...
class SettingsController(NSObject):
    ...
    def onSignInClicked_(self, _sender) -> None:
        # Sign in via the persistent Heard window's sign-in screen (web handoff).
        from heard import home_window

        home_window.show_home(start="signin")
...
def show_onboarding() -> None:
    """Open first-launch onboarding (the persistent Heard window)."""
    from heard import home_window
